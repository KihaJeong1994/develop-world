...
class WebGLDwd extends StatefulWidget {
  final String fileName;

  const WebGLDwd({Key? key, required this.fileName}) : super(key: key);

  @override
  State<WebGLDwd> createState() => _MyAppState();
}

class _MyAppState extends State<WebGLDwd> {
